...
- (void)artButtonPressed:(id)sender
{
    ...
    if (thisPhoto.photoAttribution) {
        [self createddate];
        [(UILabel*)[imgView.photoAttributionButton viewWithTag:kAttributionButtonLabelTag] setText:[NSString stringWithFormat:@"Photo by %@, Posted %@", thisPhoto.photoAttribution,string]];
    }
    else {
